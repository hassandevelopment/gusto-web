 ...
 *
 * basename="/Gusto-Menu" matches vite.config.ts `base: '/Gusto-Menu/'`.
 * If we move to a custom domain (e.g. gusto.bh) later, change both to "/".
 *
 * Note for GitHub Pages SPA: when a user lands directly on /Gusto-Menu/menu
...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <ErrorBoundary>
      <BrowserRouter basename="/Gusto-Menu">
        <Routes>
